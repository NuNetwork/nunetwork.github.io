...
<a class="btn btn-primary" href="{{ site.url }}{{ site.baseurl }}/NuBits Whitepaper 2014-09-23.pdf">Whitepaper PDF (English)</a> <a class="btn btn-primary" href="{{ site.url }}{{ site.baseurl }}/NuBits Whitepaper 2014-09-23 zh_CN.pdf">白皮书（中文）</a>
